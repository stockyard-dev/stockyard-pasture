...
import (
	...
	"github.com/stockyard-dev/stockyard-pasture/internal/license"
	"github.com/stockyard-dev/stockyard-pasture/internal/server"
...
func main() {
	...
	licenseKey := os.Getenv("PASTURE_LICENSE_KEY")
	...
	log.Printf("Stockyard Pasture listening on :%s (tier: %s)", port, tier)
